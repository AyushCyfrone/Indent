...
function ShowingRaisedDraftItems({ id, items, setShowitems }) {
    ...
    <div class="flex flex-col max-h-screen h-screen w-full">
        ...
        <footer class="container h-auto ">
            <div className="fixed bottom-0 left-0 right-0  w-full h-[36px] flex justify-end mb-10 gap-4 px-10">
                <NavLink to="/Indent">
                    <div onClick={() => (setShowitems(false))}><WhiteButton text={"Done"} /></div>
                </NavLink>
                <NavLink to="/OrderRequest/Draft"> 
...
export default ShowingRaisedDraftItems;
