...
import ShowingRaisedToStore from "./ShowingRaisedToStoreItems";

function RaisedToStore (){
    ...
    return (
        ...
        {showitems && <ShowingRaisedToStore items={approvedItems} setShowitems={setShowItems} kitchen={kitchen} />}
        {console.log("Before Sending ... + " + approvedItems)}
        </> 
    )
}

export default RaisedToStore;
