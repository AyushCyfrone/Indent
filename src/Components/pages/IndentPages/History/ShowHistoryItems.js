...
const HeaderCardItems = ["Item Name","UOM","Requested Quantity","Received Quantity","Status"];
  ...
  return (
    ...
    <div className="font-sans">
      <div className={`grid grid-cols-5 sm:grid-cols-5 md:grid-cols-5 mt-1 w-full lg:h-[48px] h-[40px] 
        ...
        <div className=" pl-2 flex justify-center items-center text-blue-500">     
            <span class="text-right w-10">Delivered</span>
        </div>
      </div>
    </div>
    </>
...
function ShowHistoryItems() {
    ...
    const {existingdraft, rawIngredients, inventoryItems, image, uom, parlevel, updateRaisedStatus, updateStatustoDraft} = useAuth();
  ...
  return (
    <div>
        ...
        {(role === "HOD") && <div class="h-auto flex justify-end mt-4">
            
            <div class="flex gap-4">
              <div ><WhiteButton text={"Reject"}/></div>
